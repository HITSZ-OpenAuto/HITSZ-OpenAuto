...
extern void dev_display_shape_matching_results (HTuple hv_ModelID, HTuple hv_Color, 
...
void action()
{
  ...
  CreateScaledShapeModel(ho_chipImage, "auto", 0, 3.14, "auto", 0.5, 2.0, "auto", 
      "auto", "use_polarity", "auto", "auto", &hv_ModelID);

  FindScaledShapeModel(ho_boardImage, hv_ModelID, 0, 3.14, 0.5, 2.0, 0.8, 1, 0.5, 
      "least_squares", 0.1, 0.4, &hv_Row, &hv_Column, &hv_Angle, &hv_Scale, &hv_Score);
  ...
  disp_message(hv_WindowHandleforBoard, "Angle: "+hv_Angle, "window", 60, 12, "black", 
      "true");
  disp_message(hv_WindowHandleforBoard, "Scale: "+hv_Scale, "window", 75, 12, "black", 
      "true");
