...
![Snipaste_2022-11-28_14-21-01](pic/Snipaste_2022-11-28_14-21-01.png)
...
![Snipaste_2022-11-28_14-21-45](pic/Snipaste_2022-11-28_14-21-45.png)
...
![Snipaste_2022-11-28_14-27-06](pic/Snipaste_2022-11-28_14-27-06.png)

第四章开始，介绍了各个寄存器代表的意义和设置数值对应的结果，这一部分是读取的时候需要参考的，这里不再详细介绍

![Snipaste_2022-11-28_14-32-06](pic/Snipaste_2022-11-28_14-32-06.png)

第五章开始，列出了BMI088的加速度计和陀螺仪的寄存器表，这也是读取的时候需要参考的部分，这里不过多讲解

![Snipaste_2022-11-28_14-33-31](pic/Snipaste_2022-11-28_14-33-31.png)

第六章开始，讲述了如何使用SPI或者I2C与BMI088进行数据通信，这一章比较重要，是我们读取的基础

![Snipaste_2022-11-28_14-35-13](pic/Snipaste_2022-11-28_14-35-13.png)

第七章是BMI088的引脚图

![Snipaste_2022-11-28_14-36-25](pic/Snipaste_2022-11-28_14-36-25.png)

第八章是BMI088的设计参考图，以及需要参考的电路设计参数

![Snipaste_2022-11-28_14-36-53](pic/Snipaste_2022-11-28_14-36-53.png)

第九章是免责声明

![Snipaste_2022-11-28_14-38-02](pic/Snipaste_2022-11-28_14-38-02.png)
...
![Snipaste_2022-11-28_14-40-59](pic/Snipaste_2022-11-28_14-40-59.png)
...
![Snipaste_2022-11-28_14-46-45](pic/Snipaste_2022-11-28_14-46-45-166961897247614.png)
...
![Snipaste_2022-11-28_15-17-03](pic/Snipaste_2022-11-28_15-17-03.png)

这里的值的第一位是bit7，也就是MSB端，所以可以断定我们的First Bit是MSB first

然后就到了时钟配置的预分频系数Prescaler这里，这里注意到是要跟你C板的时钟配置相关联的，放出我的C板时钟配置

![Snipaste_2022-11-28_14-55-07](pic/Snipaste_2022-11-28_14-55-07.png)

其中，C板（F406芯片）的SPI1总线是挂载在APB1时钟上的，也就是说这个时候SPI1的初始时钟是84MHz，我们再来看数据手册中关于SPI的时钟要求

![Snipaste_2022-11-28_14-57-19](pic/Snipaste_2022-11-28_14-57-19.png)
...
![Snipaste_2022-11-28_15-19-43](pic/Snipaste_2022-11-28_15-19-43.png)
...
![Snipaste_2022-11-28_15-25-54](pic/Snipaste_2022-11-28_15-25-54.png)
...
![Snipaste_2022-11-28_15-29-00](pic/Snipaste_2022-11-28_15-29-00.png)
...
![image-20221128164832312](pic/image-20221128164832312.png)